package com.javalesson.oop.concurrency.locks;
...
public class SynchronizedBuffer {
    ...
    private static void blockingWrite() {
        for (int i = 0; i < 10; i++) {
            ...
            try {
                while (!isEmpty) {
                    System.out.println(RED + "Writer tries to access resource");
    ...
    private static void blockingRead() {
        for (int i = 0; i < 10; i++) {
            ...
            try {
                while (isEmpty) {
                    System.out.println(BLUE + "Reader tries to access resource");
