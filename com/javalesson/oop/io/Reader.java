...
public class Reader {
    ...
    public static void nioReadFileWithBuffer(String fileName) throws IOException {
        Path path = Paths.get(fileName);
    ...
    public static void nioReadWithStream(String fileName) throws IOException {
        Path path = Paths.get(fileName);
    ...
    public static void nioReadWithChannel(String fileName) throws IOException {
