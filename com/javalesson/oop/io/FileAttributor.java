...
public class FileAttributor {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Last access time: " + dosFileAttributes.lastAccessTime());
        System.out.println("Is regular file: " + dosFileAttributes.isRegularFile());
...
//        Files.createFile(Paths.get("file1.txt"), fileAttribs);
        ...
        UserPrincipal user = path.getFileSystem().getUserPrincipalLookupService().lookupPrincipalByName("icehead");
