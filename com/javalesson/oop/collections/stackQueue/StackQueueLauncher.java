package com.javalesson.oop.collections.stackQueue;

import com.javalesson.oop.collections.collectionsClass.Card;
import com.javalesson.oop.collections.collectionsClass.CardComparator;
...
/*        for (int i = 0; i < 10; i++) {
    ...
    private static void passengerProcessing() {
        ...
        Passenger passenger = new Passenger("Ekaterina", "Ivanova");
